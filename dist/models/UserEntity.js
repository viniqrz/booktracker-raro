...
const ReadEntity_1 = require("./ReadEntity");
...
__decorate([
    (0, typeorm_1.OneToMany)(() => SessionEntity_1.Session, (session) => session.user),
    __metadata("design:type", Array)
], User.prototype, "sessions", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => ReadEntity_1.Read, (read) => read.user),
    __metadata("design:type", Array)
